...
<!-- Mirrored from demos.sypna.ir/dashtrans/vertical/ecommerce-add-new-products by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 13:42:05 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<link rel="dns-prefetch" href="http://demos.sypna.ir/">
<link rel="dns-prefetch" href="http://fonts.googleapis.com/">
<link rel="dns-prefetch" href="http://www.rtl-theme.com/">
	
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>

	<link rel="icon" href="../../dashtrans_res/vertical/assets/images/favicon-32x32.png" type="image/png" />
	
	<link href="../../dashtrans_res/vertical/assets/plugins/Drag-And-Drop/dist/imageuploadify.min.css" rel="stylesheet" />
	<link href="../../dashtrans_res/vertical/assets/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
	<link href="../../dashtrans_res/vertical/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet" />
	<link href="../../dashtrans_res/vertical/assets/plugins/metismenu/css/metisMenu.min.css" rel="stylesheet" />
	
	<link href="../../dashtrans_res/vertical/assets/css/pace.min.css" rel="stylesheet" />
	<script src="../../dashtrans_res/vertical/assets/js/pace.min.js">
								</script>
	
	<link href="../../dashtrans_res/vertical/assets/css/bootstrap.min.css" rel="stylesheet">
	<link href="../../dashtrans_res/vertical/assets/css/bootstrap-extended.css" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&amp;display=swap" rel="stylesheet">
	
	<link href="../../dashtrans_res/vertical/assets/css/icons.css" rel="stylesheet">
	<link rel="stylesheet" href="../../fonts/vazir/Farsi-Digits/Vazirmatn-FD-font-face.css">
	<link rel="stylesheet" href="../../dashtrans_res/vertical/assets/css/app.css">
	<title>دش ترنس - قالب HTML مدیریت</title>
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="../../dashtrans_res/vertical/assets/images/logo-icon.png" class="logo-icon" alt="توضیح تصویر">
				</div>
				<div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="{{route('list.category')}}">

							<i  class='bx bx-radio-circle'>
								</i>لیست دسته بندی ها</a>
						</li>
						<li> <a href="{{route('index.category')}}">

							<i  class='bx bx-radio-circle'>
								</i> افزودن دسته بندی </a>
						</li>
				...
				<li>
					<a href="https://www.rtl-theme.com/author/saeed410/products/" target="_blank">
						<div class="parent-icon">
				...
				<nav class="navbar navbar-expand gap-3">
					...
					<div class="top-menu ms-auto">
						<ul class="navbar-nav align-items-center gap-1">
							...
							<li class="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
								...
								<img src="../../dashtrans_res/vertical/assets/images/county/02.png" width="22"
										alt="توضیح تصویر">
								</a>
								...
								<img
												src="../../dashtrans_res/vertical/assets/images/county/01.png" width="20" alt="توضیح تصویر">
								<span
								...
								<a class="dropdown-item d-flex align-items-center py-2" href="javascript:;">
								<img
												src="../../dashtrans_res/vertical/assets/images/county/02.png" width="20" alt="توضیح تصویر">
								<span
								...
								<a class="dropdown-item d-flex align-items-center py-2" href="javascript:;">
								<img
												src="../../dashtrans_res/vertical/assets/images/county/03.png" width="20" alt="توضیح تصویر">
								<span
								...
								<a class="dropdown-item d-flex align-items-center py-2" href="javascript:;">
								<img
												src="../../dashtrans_res/vertical/assets/images/county/04.png" width="20" alt="توضیح تصویر">
								<span
								...
								<a class="dropdown-item d-flex align-items-center py-2" href="javascript:;">
								<img
												src="../../dashtrans_res/vertical/assets/images/county/05.png" width="20" alt="توضیح تصویر">
								<span
								...
								<a class="dropdown-item d-flex align-items-center py-2" href="javascript:;">
								<img
												src="../../dashtrans_res/vertical/assets/images/county/06.png" width="20" alt="توضیح تصویر">
								<span
								...
								<a class="dropdown-item d-flex align-items-center py-2" href="javascript:;">
								<img
												src="../../dashtrans_res/vertical/assets/images/county/07.png" width="20" alt="توضیح تصویر">
								<span
								...
								<a class="dropdown-item d-flex align-items-center py-2" href="javascript:;">
								<img
												src="../../dashtrans_res/vertical/assets/images/county/08.png" width="20" alt="توضیح تصویر">
								<span
										...
										<div class="row gx-0 gy-2 row-cols-3 justify-content-center p-2">
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/slack.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/behance.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/google-drive.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/outlook.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/github.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/stack-overflow.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/figma.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
															<p class="mb-0 mt-1">استک</p>
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/twitter.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/google-calendar.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/spotify.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/google-photos.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/pinterest.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
															<p class="mb-0 mt-1">تصاویر</p>
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/linkedin.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/dribble.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
															<p class="mb-0 mt-1">دریبل</p>
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/youtube.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/google.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/envato.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
											...
											<div class="col">
												<a href="javascript:;">
													<div class="app-box text-center">
														<div class="app-icon">
															<img src="../../dashtrans_res/vertical/assets/images/app/safari.png" width="30"
																alt="توضیح تصویر">
														</div>
														<div class="app-name">
							...
							<li class="nav-item dropdown dropdown-large">
								...
								<div class="dropdown-menu dropdown-menu-end">
									...
									<div class="header-notifications-list">
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="../../dashtrans_res/vertical/assets/images/avatars/avatar-1.png" class="msg-avatar"
														alt="توضیح تصویر">
												</div>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="../../dashtrans_res/vertical/assets/images/avatars/avatar-2.png" class="msg-avatar"
														alt="توضیح تصویر">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="notify bg-light-success text-success">
													<img src="../../dashtrans_res/vertical/assets/images/app/outlook.png" width="25"
														alt="توضیح تصویر">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="../../dashtrans_res/vertical/assets/images/avatars/avatar-4.png" class="msg-avatar"
														alt="توضیح تصویر">
												</div>
												<div class="flex-grow-1">
								...
								<i
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="notify bg-light-primary">
													<img src="../../dashtrans_res/vertical/assets/images/app/github.png" width="25"
														alt="توضیح تصویر">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="../../dashtrans_res/vertical/assets/images/avatars/avatar-8.png" class="msg-avatar"
														alt="توضیح تصویر">
												</div>
												<div class="flex-grow-1">
											...
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="../../dashtrans_res/vertical/assets/images/products/11.png" class=""
															alt="توضیح تصویر">
													</div>
												</div>
												<div class="flex-grow-1">
							...
							<i  class="bx bx-x">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="../../dashtrans_res/vertical/assets/images/products/02.png" class=""
															alt="توضیح تصویر">
													</div>
												</div>
												<div class="flex-grow-1">
							...
							<i  class="bx bx-x">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="../../dashtrans_res/vertical/assets/images/products/03.png" class=""
															alt="توضیح تصویر">
													</div>
												</div>
												<div class="flex-grow-1">
							...
							<i  class="bx bx-x">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="../../dashtrans_res/vertical/assets/images/products/04.png" class=""
															alt="توضیح تصویر">
													</div>
												</div>
												<div class="flex-grow-1">
							...
							<i  class="bx bx-x">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="../../dashtrans_res/vertical/assets/images/products/05.png" class=""
															alt="توضیح تصویر">
													</div>
												</div>
												<div class="flex-grow-1">
							...
							<i  class="bx bx-x">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="../../dashtrans_res/vertical/assets/images/products/06.png" class=""
															alt="توضیح تصویر">
													</div>
												</div>
												<div class="flex-grow-1">
							...
							<i  class="bx bx-x">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="../../dashtrans_res/vertical/assets/images/products/07.png" class=""
															alt="توضیح تصویر">
													</div>
												</div>
												<div class="flex-grow-1">
							...
							<i  class="bx bx-x">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="../../dashtrans_res/vertical/assets/images/products/08.png" class=""
															alt="توضیح تصویر">
													</div>
												</div>
												<div class="flex-grow-1">
							...
							<i  class="bx bx-x">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="../../dashtrans_res/vertical/assets/images/products/09.png" class=""
															alt="توضیح تصویر">
													</div>
												</div>
												<div class="flex-grow-1">
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
							...
							<img src="../../dashtrans_res/vertical/assets/images/avatars/avatar-2.png" class="user-img" alt="توضیح تصویر">
							<div class="user-info">

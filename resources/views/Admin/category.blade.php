                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="border border-3 p-4 rounded">
                                <div class="mb-3">
                                    <form action="{{ route('create.category.store') }}" method="POST">
                                        @csrf
                                    <label for="inputProductTitle" class="form-label">عنوان محصول</label>
                                    <input name="title" type="text" class="form-control" id="inputProductTitle"
                                        placeholder="عنوان دسته بندی را وارد کنید">

                                    <label for="inputProductTitle" class="form-label">عنوان محصول</label>
                                    <input name="slug" type="text" class="form-control" id="inputProductTitle"

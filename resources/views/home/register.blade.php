      ...
      <div class="row justify-center items-center">
        <div class="col-xl-8 col-lg-9">
          ...
          <div class="px-50 py-50 md:px-25 md:py-25 bg-white shadow-1 rounded-16">
            ...
            <p class="mt-10">آیا قبلا ثبت نام کرده اید؟ <a href="login.html" class="text-purple-1">ورود</a></p>

     

            <form action="{{route('register.store')}}" method="POST" class="contact-form respondForm__form row y-gap-20 pt-30" >


              @csrf
              
              <div class="col-lg-6">
                <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">نام کاربری</label>
              ...
              <div class="col-lg-6">
                <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">تایید رمز عبور *</label>
                <input type="text" name="password-verify" placeholder="*********">
              </div>
              <div class="col-12">

...
function img_default_noti() {
    Lobibox.notify("default", {
        ...
        continueDelayOnInactiveTab: false,
        position: "top right",
        img: "../../dashtrans_res/vertical/assets/plugins/notifications/img/1.jpg", //path to image
        msg: "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ .",
    });
}
...
function img_info_noti() {
    Lobibox.notify("info", {
        ...
        icon: "bx bx-info-circle",
        position: "top right",
        img: "../../dashtrans_res/vertical/assets/plugins/notifications/img/2.jpg", //path to image
        msg: "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ .",
    });
}
...
function img_warning_noti() {
    Lobibox.notify("warning", {
        ...
        continueDelayOnInactiveTab: false,
        position: "top right",
        img: "../../dashtrans_res/vertical/assets/plugins/notifications/img/3.jpg", //path to image
        msg: "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ .",
    });
}
...
function img_error_noti() {
    Lobibox.notify("error", {
        ...
        icon: "bx bx-x-circle",
        position: "top right",
        img: "../../dashtrans_res/vertical/assets/plugins/notifications/img/4.jpg", //path to image
        msg: "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ .",
    });
}
...
function img_success_noti() {
    Lobibox.notify("success", {
        ...
        position: "top right",
        icon: "bx bx-check-circle",
        img: "../../dashtrans_res/vertical/assets/plugins/notifications/img/5.jpg", //path to image
        msg: "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ .",
    });
}
/* Notifications With Images*/
